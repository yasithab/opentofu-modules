module "wrapper" {
  ...
  authorization_type                           = try(each.value.authorization_type, var.defaults.authorization_type, "AWS_IAM")
  build_in_docker                              = try(each.value.build_in_docker, var.defaults.build_in_docker, false)
  capacity_provider_config                     = try(each.value.capacity_provider_config, var.defaults.capacity_provider_config, null)
  ...
  code_sha256                                  = try(each.value.code_sha256, var.defaults.code_sha256, null)
  ...
  cors                                         = try(each.value.cors, var.defaults.cors, null)
  ...
  durable_config                               = try(each.value.durable_config, var.defaults.durable_config, null)
  ...
  provisioned_concurrency_skip_destroy         = try(each.value.provisioned_concurrency_skip_destroy, var.defaults.provisioned_concurrency_skip_destroy, false)
  ...
  s3_server_side_encryption                    = try(each.value.s3_server_side_encryption, var.defaults.s3_server_side_encryption, "AES256")
  ...
  tenancy_config                               = try(each.value.tenancy_config, var.defaults.tenancy_config, null)
