...
# Extra mock defaults live in scripts/offline-test-mocks/service-control-policy.hcl.
# Regenerate with: python3 scripts/generate-offline-tests.py service-control-policy
