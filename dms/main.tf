...
resource "aws_dms_replication_subnet_group" "this" {
  ...
  tags = merge(local.tags, var.repl_subnet_group_tags)
...
resource "aws_dms_replication_instance" "this" {
  ...
  dns_name_servers             = var.repl_instance_dns_name_servers
  ...
  dynamic "kerberos_authentication_settings" {
    for_each = var.repl_instance_kerberos_authentication_settings != null ? [var.repl_instance_kerberos_authentication_settings] : []

    content {
      key_cache_secret_iam_arn = try(kerberos_authentication_settings.value.key_cache_secret_iam_arn, null)
      key_cache_secret_id      = try(kerberos_authentication_settings.value.key_cache_secret_id, null)
      krb5_file_contents       = try(kerberos_authentication_settings.value.krb5_file_contents, null)
    }
  }

  tags = merge(local.tags, var.repl_instance_tags)
...
resource "aws_dms_endpoint" "this" {
  ...
  dynamic "elasticsearch_settings" {
    ...
    content {
      ...
      service_access_role_arn    = lookup(elasticsearch_settings.value, "service_access_role_arn", aws_iam_role.access.arn)
  ...
  dynamic "oracle_settings" {
    ...
    content {
      ...
      allow_selected_nested_tables                  = try(oracle_settings.value.allow_selected_nested_tables, null)
      archived_log_dest_id                          = try(oracle_settings.value.archived_log_dest_id, null)
      archived_logs_only                            = try(oracle_settings.value.archived_logs_only, null)
      ...
      direct_path_no_log                            = try(oracle_settings.value.direct_path_no_log, null)
      direct_path_parallel_load                     = try(oracle_settings.value.direct_path_parallel_load, null)
      enable_homogenous_tablespace                  = try(oracle_settings.value.enable_homogenous_tablespace, null)
      extra_archived_log_dest_ids                   = try(oracle_settings.value.extra_archived_log_dest_ids, null)
      ...
      open_transaction_window                       = try(oracle_settings.value.open_transaction_window, null)
      oracle_path_prefix                            = try(oracle_settings.value.oracle_path_prefix, null)
      parallel_asm_read_threads                     = try(oracle_settings.value.parallel_asm_read_threads, null)
      read_ahead_blocks                             = try(oracle_settings.value.read_ahead_blocks, null)
      read_table_space_name                         = try(oracle_settings.value.read_table_space_name, null)
      replace_path_prefix                           = try(oracle_settings.value.replace_path_prefix, null)
      ...
      spatial_data_option_to_geo_json_function_name = try(oracle_settings.value.spatial_data_option_to_geo_json_function_name, null)
      ...
      use_alternate_folder_for_online               = try(oracle_settings.value.use_alternate_folder_for_online, null)
      use_bfile                                     = try(oracle_settings.value.use_bfile, null)
      use_direct_path_full_load                     = try(oracle_settings.value.use_direct_path_full_load, null)
      use_logminer_reader                           = try(oracle_settings.value.use_logminer_reader, null)
      use_path_prefix                               = try(oracle_settings.value.use_path_prefix, null)
    }
  }
  ...
  timeouts {
    ...
    delete = try(var.endpoint_timeouts.delete, null)
  }
}
...
resource "aws_iam_role" "access" {
  ...
  tags = merge(local.tags, var.access_iam_role_tags)
...
resource "aws_iam_policy" "access" {
  ...
  lifecycle {
    enabled = local.create_access_policy
  }
}
