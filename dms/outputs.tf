...
output "dms_access_for_endpoint_iam_role_arn" {
  ...
  value       = try(aws_iam_role.dms_access_for_endpoint.arn, null)
}

output "dms_access_for_endpoint_iam_role_id" {
  description = "Name of the IAM role"
  value       = try(aws_iam_role.dms_access_for_endpoint.id, null)
}

output "dms_access_for_endpoint_iam_role_unique_id" {
  description = "Stable and unique string identifying the role"
  value       = try(aws_iam_role.dms_access_for_endpoint.unique_id, null)
}

# DMS CloudWatch Logs
output "dms_cloudwatch_logs_iam_role_arn" {
  description = "Amazon Resource Name (ARN) specifying the role"
  value       = try(aws_iam_role.dms_cloudwatch_logs_role.arn, null)
}

output "dms_cloudwatch_logs_iam_role_id" {
  description = "Name of the IAM role"
  value       = try(aws_iam_role.dms_cloudwatch_logs_role.id, null)
}

output "dms_cloudwatch_logs_iam_role_unique_id" {
  description = "Stable and unique string identifying the role"
  value       = try(aws_iam_role.dms_cloudwatch_logs_role.unique_id, null)
}

# DMS VPC
output "dms_vpc_iam_role_arn" {
  description = "Amazon Resource Name (ARN) specifying the role"
  value       = try(aws_iam_role.dms_vpc_role.arn, null)
}

output "dms_vpc_iam_role_id" {
  description = "Name of the IAM role"
  value       = try(aws_iam_role.dms_vpc_role.id, null)
}

output "dms_vpc_iam_role_unique_id" {
  description = "Stable and unique string identifying the role"
  value       = try(aws_iam_role.dms_vpc_role.unique_id, null)
}
...
output "replication_subnet_group_id" {
  ...
  value       = try(aws_dms_replication_subnet_group.this.id, null)
}
...
output "replication_instance_arn" {
  ...
  value       = try(aws_dms_replication_instance.this.replication_instance_arn, null)
}

output "replication_instance_private_ips" {
  description = "A list of the private IP addresses of the replication instance"
  value       = try(aws_dms_replication_instance.this.replication_instance_private_ips, null)
}

output "replication_instance_public_ips" {
  description = "A list of the public IP addresses of the replication instance"
  value       = try(aws_dms_replication_instance.this.replication_instance_public_ips, null)
}

output "replication_instance_tags_all" {
  description = "A map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block"
  value       = try(aws_dms_replication_instance.this.tags_all, null)
}
