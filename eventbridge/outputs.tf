...
output "eventbridge_role_arn" {
  ...
  value       = try(aws_iam_role.eventbridge.arn, "")
}

output "eventbridge_role_name" {
  description = "The name of the IAM role created for EventBridge"
  value       = try(aws_iam_role.eventbridge.name, "")
}
