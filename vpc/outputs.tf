locals {
  redshift_route_table_ids = try(aws_route_table.redshift.id, null)
...
output "outpost_network_acl_id" {
  ...
  value       = try(aws_network_acl.outpost.id, null)
}

output "outpost_network_acl_arn" {
  description = "ARN of the outpost network ACL"
  value       = try(aws_network_acl.outpost.arn, null)
}
...
output "redshift_subnet_group" {
  ...
  value       = try(aws_redshift_subnet_group.redshift.id, null)
}

output "redshift_route_table_ids" {
  description = "List of IDs of redshift route tables"
  value       = local.redshift_route_table_ids != null ? [local.redshift_route_table_ids] : (var.enable_public_redshift ? local.public_route_table_ids : local.private_route_table_ids)
}
...
output "redshift_network_acl_id" {
  ...
  value       = try(aws_network_acl.redshift.id, null)
}

output "redshift_network_acl_arn" {
  description = "ARN of the redshift network ACL"
  value       = try(aws_network_acl.redshift.arn, null)
}
...
output "elasticache_subnet_group" {
  ...
  value       = try(aws_elasticache_subnet_group.elasticache.id, null)
}

output "elasticache_subnet_group_name" {
  description = "Name of elasticache subnet group"
  value       = try(aws_elasticache_subnet_group.elasticache.name, null)
}

output "elasticache_route_table_ids" {
  description = "List of IDs of elasticache route tables"
  value       = try([aws_route_table.elasticache.id], local.private_route_table_ids)
}
...
output "elasticache_network_acl_id" {
  ...
  value       = try(aws_network_acl.elasticache.id, null)
}

output "elasticache_network_acl_arn" {
  description = "ARN of the elasticache network ACL"
  value       = try(aws_network_acl.elasticache.arn, null)
}
...
output "intra_network_acl_id" {
  ...
  value       = try(aws_network_acl.intra.id, null)
}

output "intra_network_acl_arn" {
  description = "ARN of the intra network ACL"
  value       = try(aws_network_acl.intra.arn, null)
}
...
output "natgw_ids" {
  ...
  value       = local.nat_type == "regional" ? aws_nat_gateway.regional[*].id : aws_nat_gateway.this[*].id
}

output "natgw_interface_ids" {
  description = "List of Network Interface IDs assigned to NAT Gateways"
  value       = local.nat_type == "regional" ? aws_nat_gateway.regional[*].network_interface_id : aws_nat_gateway.this[*].network_interface_id
}
...
output "egress_only_internet_gateway_id" {
  ...
  value       = try(aws_egress_only_internet_gateway.this.id, null)
}
...
output "vgw_id" {
  ...
  value       = try(aws_vpn_gateway.this.id, aws_vpn_gateway_attachment.this.vpn_gateway_id, null)
}
...
output "default_vpc_id" {
  ...
  value       = try(aws_default_vpc.this.id, null)
}

output "default_vpc_arn" {
  description = "The ARN of the Default VPC"
  value       = try(aws_default_vpc.this.arn, null)
}

output "default_vpc_cidr_block" {
  description = "The CIDR block of the Default VPC"
  value       = try(aws_default_vpc.this.cidr_block, null)
}

output "default_vpc_default_security_group_id" {
  description = "The ID of the security group created by default on Default VPC creation"
  value       = try(aws_default_vpc.this.default_security_group_id, null)
}

output "default_vpc_default_network_acl_id" {
  description = "The ID of the default network ACL of the Default VPC"
  value       = try(aws_default_vpc.this.default_network_acl_id, null)
}

output "default_vpc_default_route_table_id" {
  description = "The ID of the default route table of the Default VPC"
  value       = try(aws_default_vpc.this.default_route_table_id, null)
}

output "default_vpc_instance_tenancy" {
  description = "Tenancy of instances spin up within Default VPC"
  value       = try(aws_default_vpc.this.instance_tenancy, null)
}

output "default_vpc_enable_dns_support" {
  description = "Whether or not the Default VPC has DNS support"
  value       = try(aws_default_vpc.this.enable_dns_support, null)
}

output "default_vpc_enable_dns_hostnames" {
  description = "Whether or not the Default VPC has DNS hostname support"
  value       = try(aws_default_vpc.this.enable_dns_hostnames, null)
}

output "default_vpc_main_route_table_id" {
  description = "The ID of the main route table associated with the Default VPC"
  value       = try(aws_default_vpc.this.main_route_table_id, null)
}
...
output "vpc_flow_log_deliver_cross_account_role" {
  ...
  value       = try(aws_flow_log.this.deliver_cross_account_role, null)
}
