# Transit Gateway VPC Attachments Module - Examples
...
module "tgw_vpc_attachments" {
  source = "git::https://github.com/yasithab/opentofu-modules.git//transit-gateway/vpc-attachments?depth=1&ref=v2.0.0"
