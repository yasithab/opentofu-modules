...
| <a name="input_enabled"></a> [enabled](#input\_enabled) | Determines whether to create Fargate profile or not | `bool` | `true` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name of the EKS Fargate Profile | `string` | `null` | no |
