...
variable "ira_profile_enabled" {
  description = "Whether the Roles Anywhere profile is enabled"
  type        = bool
  default     = null
}

variable "ira_profile_accept_role_session_name" {
  description = "Whether the Roles Anywhere profile allows custom role session names in CreateSession requests. Defaults to false"
  type        = bool
  default     = null
}
...
variable "ira_trust_anchor_enabled" {
  description = "Whether the Roles Anywhere trust anchor is enabled"
  type        = bool
  default     = null
}
