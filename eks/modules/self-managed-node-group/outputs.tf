...
output "autoscaling_group_availability_zones" {
  ...
  value       = try(aws_autoscaling_group.this.availability_zones, null)
}

output "autoscaling_group_vpc_zone_identifier" {
  description = "The VPC zone identifier"
  value       = try(aws_autoscaling_group.this.vpc_zone_identifier, null)
}
...
output "iam_instance_profile_arn" {
  ...
  value       = try(aws_iam_instance_profile.this.arn, var.iam_instance_profile_arn)
}
...
output "access_entry_arn" {
  ...
  value       = try(aws_eks_access_entry.this.access_entry_arn, null)
}
...
output "image_id" {
  ...
  value       = try(aws_launch_template.this.image_id, null)
}
