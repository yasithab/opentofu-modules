output "serverless_cache_arn" {
  ...
  value       = try(aws_elasticache_serverless_cache.this.arn, null)
}

output "serverless_cache_create_time" {
  description = "Timestamp of when the serverless cache was created"
  value       = try(aws_elasticache_serverless_cache.this.create_time, null)
}
...
output "serverless_cache_endpoint" {
  ...
  value       = try(one(aws_elasticache_serverless_cache.this.endpoint), null)
}
...
output "serverless_cache_full_engine_version" {
  ...
  value       = try(aws_elasticache_serverless_cache.this.full_engine_version, null)
}
...
output "serverless_cache_major_engine_version" {
  ...
  value       = try(aws_elasticache_serverless_cache.this.major_engine_version, null)
}

output "serverless_cache_reader_endpoint" {
  description = "Represents the information required for client programs to connect to a cache node"
  value       = try(one(aws_elasticache_serverless_cache.this.reader_endpoint), null)
}
...
output "serverless_cache_status" {
  ...
  value       = try(aws_elasticache_serverless_cache.this.status, null)
}
