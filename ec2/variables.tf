...
variable "force_destroy" {
  description = "If true, all Elastic IPs and network interfaces associated with the instance will be deleted along with the instance"
  type        = bool
  default     = null
}
...
variable "host_resource_group_arn" {
  description = "ARN of the host resource group in which to launch the instances. If you specify a Host Resource Group ARN, omit the Tenancy parameter or set it to host"
  type        = string
  default     = null
}
...
variable "placement_group_id" {
  description = "The ID of the Placement Group to start the instance in, if applicable. Used for partition placement groups."
  type        = string
  default     = null
}
...
variable "enable_primary_ipv6" {
  description = "Whether to assign a primary IPv6 Global Unicast Address (GUA) to the instance when launched in a dual-stack or IPv6-only subnet. Requires ipv6_address_count or ipv6_addresses to also be configured."
  type        = bool
  default     = null
}
...
variable "iam_role_max_session_duration" {
  description = "Maximum session duration (in seconds) that you want to set for the specified role. Valid values are between 3600 and 43200"
  type        = number
  default     = null
}
...
variable "eip_network_interface" {
  description = "Network interface ID to associate with. Conflicts with instance"
  type        = string
  default     = null
}
