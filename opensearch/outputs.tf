...
output "domain_id" {
  ...
  value       = try(aws_opensearch_domain.this.domain_id, null)
}

output "domain_endpoint" {
  description = "Domain-specific endpoint used to submit index, search, and data upload requests"
  value       = try(aws_opensearch_domain.this.endpoint, null)
}
...
output "domain_dashboard_endpoint_v2" {
  ...
  value       = try(aws_opensearch_domain.this.dashboard_endpoint_v2, null)
}
