output "conformance_pack_arn" {
  ...
  value       = local.create && !var.create_organization_conformance_pack ? aws_config_conformance_pack.this.arn : null
}
...
output "conformance_pack_id" {
  ...
  value       = local.create && !var.create_organization_conformance_pack ? aws_config_conformance_pack.this.id : null
}
...
output "organization_conformance_pack_arn" {
  ...
  value       = local.create && var.create_organization_conformance_pack ? aws_config_organization_conformance_pack.this.arn : null
}
...
output "organization_conformance_pack_id" {
  ...
  value       = local.create && var.create_organization_conformance_pack ? aws_config_organization_conformance_pack.this.id : null
}
