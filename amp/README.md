...
- **Alert Manager** - Configure alert manager definitions for routing and receiving alerts
- **Rule Group Namespaces** - Define Prometheus recording and alerting rules
- **CloudWatch Logging** - Automatic log group creation with configurable retention and encryption
...
module "amp" {
  ...
  workspace_alias = "my-prometheus-workspace"
