...
output "access_iam_role_name" {
  ...
  value       = try(aws_iam_role.access.name, null)
}

output "access_iam_role_arn" {
  description = "The Amazon Resource Name (ARN) specifying the IAM role"
  value       = try(aws_iam_role.access.arn, null)
}

output "access_iam_role_unique_id" {
  description = "Stable and unique string identifying the IAM role"
  value       = try(aws_iam_role.access.unique_id, null)
}
...
output "instance_iam_role_name" {
  description = "The name of the IAM role"
  value       = try(aws_iam_role.instance.name, null)
}

output "instance_iam_role_arn" {
  description = "The Amazon Resource Name (ARN) specifying the IAM role"
  value       = try(aws_iam_role.instance.arn, null)
}

output "instance_iam_role_unique_id" {
  description = "Stable and unique string identifying the IAM role"
  value       = try(aws_iam_role.instance.unique_id, null)
}
...
output "vpc_ingress_connection_arn" {
  ...
  value       = try(aws_apprunner_vpc_ingress_connection.this.arn, null)
}

output "vpc_ingress_connection_domain_name" {
  description = "The domain name associated with the VPC Ingress Connection resource"
  value       = try(aws_apprunner_vpc_ingress_connection.this.domain_name, null)
}
...
output "custom_domain_association_id" {
  ...
  value       = try(aws_apprunner_custom_domain_association.this.id, null)
}
...
output "custom_domain_association_certificate_validation_records" {
  ...
  value       = try(aws_apprunner_custom_domain_association.this.certificate_validation_records, null)
}
...
output "custom_domain_association_dns_target" {
  ...
  value       = try(aws_apprunner_custom_domain_association.this.dns_target, null)
}
...
output "vpc_connector_arn" {
  ...
  value       = try(aws_apprunner_vpc_connector.this.arn, null)
}
...
output "vpc_connector_status" {
  ...
  value       = try(aws_apprunner_vpc_connector.this.status, null)
}
...
output "vpc_connector_revision" {
  ...
  value       = try(aws_apprunner_vpc_connector.this.vpc_connector_revision, null)
}
...
output "observability_configuration_arn" {
  ...
  value       = try(aws_apprunner_observability_configuration.this.arn, null)
}

output "observability_configuration_revision" {
  description = "The revision of the observability configuration"
  value       = try(aws_apprunner_observability_configuration.this.observability_configuration_revision, null)
}
...
output "observability_configuration_latest" {
  ...
  value       = try(aws_apprunner_observability_configuration.this.latest, null)
}
...
output "observability_configuration_status" {
  ...
  value       = try(aws_apprunner_observability_configuration.this.status, null)
}
